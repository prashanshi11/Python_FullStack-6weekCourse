...
| **Tue (8)**  | **Django Basics**<br>• Introduction to Django Framework<br>• Setting up a Django Project and Apps<br>• Models, Views, and Templates (MVT)<br>• Hands-On: Create a Simple Django App                                            | 📁 [`01_myproject/`](./code/Backend/Django/01_myproject/)<br>▪ `members/`, `myproject/`, `templates/index.html`                                                                                              |
