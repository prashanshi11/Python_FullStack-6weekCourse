...
| **Wed (9)**  | **Django Models and ORM**<br>• Defining Models and Relationships<br>• Database Migrations and Admin Panel<br>• Querying with Django ORM<br>• Practice: Build a Product Catalog                                                 | 📁 [`02_student_project`](./code/Backend/Django/02_student_project), [`03_thirdproject`](./code/Backend/Django/03_thirdproject)<br>▪ `students/`, `core/`, `static/`, `templates/` |
